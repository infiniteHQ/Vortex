...
struct DestroyDistEnvironment : public Task
{

    std::shared_ptr<Task> clone() const override {
        return std::make_shared<DestroyDistEnvironment>(*this);
    }

  void init() override
  {
    this->tasktype = "DestroyDistEnvironment";
  };
  ...
  void exec() override
  {
    ...
    if(!toolchain->TaskSuccedded("CreateTemporaryUser")){
      ...
      this->addCheckVerdict("createFolders", "failed", "To run \"DestroyDistEnvironment\" you need to run \"CreateTemporaryUser\" first", "none");
      this->addCheckVerdict("giveFoldersToUser", "failed", "To run \"DestroyDistEnvironment\" you need to run \"CreateTemporaryUser\" first", "none");
    ...
    toolchain->currentLoadedSystem.put_varable(this, "directory:base", "DestroyDistEnvironment", baseDir);
    ...
    toolchain->currentLoadedSystem.put_varable(this, "directory:working_host", "DestroyDistEnvironment", crosstoolsDir);
    ...
    toolchain->currentLoadedSystem.put_varable(this, "directory:data", "DestroyDistEnvironment", baseDir);
    ...
    toolchain->currentLoadedSystem.put_varable(this, "directory:data_packages", "DestroyDistEnvironment", packages_data);
    ...
    toolchain->currentLoadedSystem.put_varable(this, "directory:data_patchs", "DestroyDistEnvironment", patchs_data);
    ...
    toolchain->currentLoadedSystem.put_varable(this, "directory:scripts_patchs", "DestroyDistEnvironment", scripts_data);
    ...
    toolchain->currentLoadedSystem.put_varable(this, "directory:sysroot", "DestroyDistEnvironment", sysrootDir);
    ...
    toolchain->currentLoadedSystem.put_varable(this, "directory:debugroot", "DestroyDistEnvironment", debugrootDir);
