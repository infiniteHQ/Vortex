  ...
  class PluginCardItem : public Cherry::Component {
   public:
    ...
    void Render() override {
      ...
      DrawHighlightedText(
          drawList, textPos, truncatedText.c_str(), m_PluginsSearch.c_str(), highlightColor, textColor, highlightTextColor);
   ...
   public:
    ...
    void RefreshCategories() {
      ...
      for (int i = 0; i < vxe::GetCurrentContext()->IO.ep.size(); i++) {
        ...
        m_AllCategories[vxe::GetCurrentContext()->IO.ep[i]->m_group]++;
      }
    }
