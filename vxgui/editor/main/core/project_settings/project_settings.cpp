...
namespace vxe {
  ...
  Cherry::Component buildComponentTree(const std::string &name, const GroupNode &node) {
  ...
  void ProjectSettings::UpdateProjectInformations() {
    vxe::UpdateProjectName(v_ProjectName);
    vxe::UpdateProjectDescription(v_ProjectDescription);
    vxe::UpdateProjectVersion(v_ProjectVersion);
    vxe::UpdateProjectAuthor(v_ProjectAuthor);
    vxe::UpdateProjectTags(v_ProjectTags);
    vxe::UpdateProjectType(v_ProjectType);
    vxe::UpdateProjectLogoPath(v_ProjectThumbnailPath);
    vxe::UpdateProjectWebsite(v_ProjectWebsite);
    vxe::UpdateProjectSupportContact(v_ProjectSupportContact);
    vxe::UpdateProjectCopyrightFile(v_ProjectCopyrightFile);
    vxe::UpdateProjectLicenseFile(v_ProjectLicenseFile);
    vxe::UpdateProjectReadmeFile(v_ProjectReadmeFile);
    vxe::UpdateProjectRequirementsFile(v_ProjectRequirementsFile);
    vxe::UpdateProjectCodeOfConductFile(v_ProjectCodeOfConductFile);
    vxe::UpdateProjectSecurityFile(v_ProjectSecurityFile);
    vxe::UpdateProjectRootContentPath(v_ProjectRootContentPath);
    vxe::UpdateProjectStartupScript(v_ProjectStartupScript);
  ...
  void ProjectSettings::Update() {
    ...
    jsonData["project"]["include_system_templates"] = current_save->include_system_templates;
              ...
              { {
                  CherryKit::KeyValParent(
                      ...
                      true,
                      {
                          ...
                          CherryKit::KeyValString("Logo path", &v_ProjectThumbnailPath),
                          CherryKit::KeyValString("Banner path", &v_ProjectBannerPath),
                      }),
                  CherryKit::KeyValParent(
                      ...
                      true,
                      {
                          ...
                          CherryKit::KeyValString("Tags (separe with commas)", &v_ProjectTags),
                      }),
                  CherryKit::KeyValParent(
                      "Publisher",
                      true,
                      {
                          ...
                          CherryKit::KeyValString("Website link", &v_ProjectWebsite),
                          CherryKit::KeyValString("Support or Contact", &v_ProjectSupportContact),
                      }),
                  CherryKit::KeyValParent(
                      "Legal",
                      true,
                      {
                          CherryKit::KeyValString("Copyright file", &v_ProjectCopyrightFile),
                  ...
                  CherryKit::KeyValParent(
                      ...
                      true,
                      {
                          CherryKit::KeyValString("Readme file", &v_ProjectReadmeFile),
                          CherryKit::KeyValString("Conventions & Requirements file", &v_ProjectRequirementsFile),
                          CherryKit::KeyValString("Code of conduct file", &v_ProjectCodeOfConductFile),
                          CherryKit::KeyValString("Safety and security file", &v_ProjectSecurityFile),
                      }),
              } });
          ...
          CherryKit::TableSimple(
              ...
              { {
                  CherryKit::KeyValParent(
                      ...
                      true,
                      {
                          CherryKit::KeyValString("Root content path", &v_ProjectRootContentPath),
                      }),
                  CherryKit::KeyValParent(
                      "Startup",
                      true,
                      {
                          CherryKit::KeyValString("Startup script (lua)", &v_ProjectStartupScript),
                      }),
              } });
        },
                ...
                "General",
                {
                    ...
                    CherryKit::KeyValCustom(
                        ...
                        [this]() {
                          ...
                          CherryKit::ComboText(CherryID("theme_selector"), "", &m_AvailableThemes, selected);
                  ...
                  CherryKit::KeyValCustom(
                      ...
                      [this]() {
                        ...
                        if (CherryKit::ButtonImageText(
                                ...
                                .GetData("isClicked") == "true") {
                          auto theme = vxe::GetTheme(m_AvailableThemes[selected]);
                          if (theme) {
                            vxe::CreateNewTheme(theme, v_NewThemeName);
                ...
                if (selected_theme) {
                  ...
                  for (auto &[topName, topNode] : root.children) {
                    if (topName == "Other parameters") {
                      ...
                      mainComponents.push_back(buildComponentTree(topName, topNode));
                    }
                  }
