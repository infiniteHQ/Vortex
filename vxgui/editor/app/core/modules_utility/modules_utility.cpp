...
void ModulesUtility::RenderModuleDeletionModal() {
  ...
  bool open = true;
  if (CherryGUI::BeginPopupModal("##delete_module_modal", &open,
                          ...
                          ImGuiWindowFlags_AlwaysAutoResize);
    {
      ...
      CherryGUI::BeginChild("##modulecard", ImVec2(MODAL_W - 40.0f, 82.0f), false,
                        ImGuiWindowFlags_NoScrollbar);
      {
      ...
      CherryGUI::TextUnformatted("This action is permanent. The module files "
