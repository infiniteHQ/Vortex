...
VORTEX_API void LoadSystemTemplates(
  ...
  auto module_files = vxe::SearchSystemFiles(path, "template.json");
  ...
  for (const auto &file : module_files) {
    try {
      ...
      VXINFO("Template registered in system ",
             new_template->m_name + " loaded with success !")
