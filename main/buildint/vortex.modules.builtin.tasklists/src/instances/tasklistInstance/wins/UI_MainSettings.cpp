...
void TasklistRenderInstance::UI_MainSettings()
{
    ...
    if (this->show_UI_MainSettings)
    {
        ...
        static ImTextureID listIcon = this->m_TaskList_Icon->GetImGuiTextureID(VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
